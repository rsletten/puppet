...
SETTINGS = {
  :url          => "https://csc-sn03.saas.local",  # e.g. https://foreman.example.com
  ...
  :ssl_cert     => "/var/lib/puppet/ssl/certs/csc-sn03.saas.local.pem",    # e.g. /var/lib/puppet/ssl/certs/FQDN.pem
  :ssl_key      => "/var/lib/puppet/ssl/private_keys/csc-sn03.saas.local.pem"      # e.g. /var/lib/puppet/ssl/private_keys/FQDN.pem
}
